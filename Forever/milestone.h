...
class Milestone {
public:
    Milestone(std::string name, std::shared_ptr<Event> trigger, bool visible, std::string description, std::string goal,
        std::vector<Dialog> dialogs, std::vector<std::shared_ptr<Change>> changes);
    ~Milestone();

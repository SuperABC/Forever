...
// 筛选/区分权重，任意lot统一给权重1，等以后设计具体建筑类型时再按类型区分，详见
// building_residence.md。
...
//
// 类名从BuildingBasic改成ResidenceBuilding(连同zone_residence.h/room_residence.h/
// component_residence.h一起)，纯改名不改行为，见zone_residence.h顶部注释。

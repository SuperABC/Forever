...
// 目录(如BuildingBasic对应的住宅/商店/工厂/医院/办公/酒店等内置建筑),完整对照表见
...
extern "C" __declspec(dllexport) void* GetModZones() {
	static vector<string> mods = { ZoneBasic::GetId() };
	return (void*)&mods;
}
...
extern "C" __declspec(dllexport) void* GetModBuildings() {
	static vector<string> mods = { BuildingBasic::GetId() };
	return (void*)&mods;
}
...
extern "C" __declspec(dllexport) void* GetModComponents() {
	static vector<string> mods = { ComponentBasic::GetId() };
	return (void*)&mods;
}
extern "C" __declspec(dllexport) void RegisterModComponents(ComponentFactory* factory) {
	factory->RegisterComponent(ComponentBasic::GetId(),
		[]() -> ComponentMod* { return new ComponentBasic(); },
...
extern "C" __declspec(dllexport) void* GetModRooms() {
	static vector<string> mods = { RoomBasic::GetId() };
	return (void*)&mods;
}
extern "C" __declspec(dllexport) void RegisterModRooms(RoomFactory* factory) {
	factory->RegisterRoom(RoomBasic::GetId(),
		[]() -> RoomMod* { return new RoomBasic(); },
		[](RoomMod* m) { delete m; });
}
...
extern "C" __declspec(dllexport) void* GetModNames() {
	static vector<string> mods = { NameBasic::GetId() };
	return (void*)&mods;
}
extern "C" __declspec(dllexport) void RegisterModNames(NameFactory* factory) {
	factory->RegisterName(NameBasic::GetId(),
		[]() -> NameMod* { return new NameBasic(); },
		[](NameMod* m) { delete m; });
}
